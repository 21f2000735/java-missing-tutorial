...
import com.learning.javamissing.sec18_architecture_and_integration.ch01_modules.topics.choosing_dependencies_and_exposed_packages.ChoosingDependenciesAndExposedPackages;
...
public class RunAllTopics {
    public static void main(String[] args) {
        run("Choosing Dependencies And Exposed Packages", () -> ChoosingDependenciesAndExposedPackages.main(args));
