...
- Which topic shows the failure first: [Querying Student Results](topics/querying_student_results/QueryingStudentResults.java).
- Which topic narrows the rule: [Querying Student Results](topics/querying_student_results/QueryingStudentResults.java).
- Which topic shows the cleaner abstraction: [Querying Student Results](topics/querying_student_results/QueryingStudentResults.java).
...
👉 Rule: Read the chapter as a small set of related ideas around talking To Databases, not as isolated trivia.
...
- Run [Querying Student Results](topics/querying_student_results/QueryingStudentResults.java) and write down what the rule becomes.
