...
export const NEXT_METADATA = {
  ...
  description: 'Learn Java from fundamentals to modern Java 25 with real-world examples, runnable code, interview tracks, design patterns, concurrency, collections, JVM internals, and migration guides.',
  metadataBase: new URL('https://21f2000735.github.io/java-missing-tutorial/')
};

export const NEXT_VIEWPORT = {
  themeColor: '#af5b0c'
};
