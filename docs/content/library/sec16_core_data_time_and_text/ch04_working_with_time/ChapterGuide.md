...
1. Step 1: Start with [Scheduling Deliveries](topics/scheduling_deliveries/SchedulingDeliveries.java) to see the raw behavior.
2. Step 2: Try the next topic to see the naive approach.
3. Step 3: Watch [Scheduling Deliveries](topics/scheduling_deliveries/SchedulingDeliveries.java) to find the failure.
4. Step 4: Use the fix step to restore correctness.
5. Step 5: Finish with [Scheduling Deliveries](topics/scheduling_deliveries/SchedulingDeliveries.java) to see the improvement.
