...
1. Step 1: Start with [Validating User Input](topics/validating_user_input/ValidatingUserInput.java) to see the raw behavior.
2. Step 2: Try the next topic to see the naive approach.
3. Step 3: Watch [Validating User Input](topics/validating_user_input/ValidatingUserInput.java) to find the failure.
4. Step 4: Use the fix step to restore correctness.
5. Step 5: Finish with [Validating User Input](topics/validating_user_input/ValidatingUserInput.java) to see the improvement.
